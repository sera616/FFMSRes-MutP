...
# ## 1.读取从webserver页面获取的信息txt文件
# def read_test_txt(seq_path):
...
# data_path='./'
# seq_path = data_path + "proteinseq.txt"
# print('--seq_path--',seq_path)
# seq_name,seq,pos,wtAA,mutAA = read_test_txt(seq_path)
# print(seq_name,seq,pos,wtAA,mutAA)
...
def feature_extract(data_path,jobid):
    seq_name,seq,pos,wtAA,mutAA = read_test_txt(data_path,jobid) ## 读取TXT文件，返回的seq_name,seq,pos,wtAA,mutAA都是list格式
